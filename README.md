...
## Registrations [https://t.me/theFreeDogs_bot/](https://t.me/theFreeDogs_bot/app?startapp=ref_MExkDhtZ)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/cucumber-pickle/FreeDogsCum.git
   cd FreeDogsCum
